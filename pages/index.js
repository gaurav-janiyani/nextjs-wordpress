...
export default function Home() {
    return (
        <>
        <Head>
            <title key="pagetitle">Welcome to Gaurav Janiyani Blog</title>
            <meta name="description" content="Gaurav Janiyani blog - read our stories" key="metadescription" />
        </Head>
        <div className="min-h-screen bg-[url('/home.jpg')] relative">
            ...
            <main>
                <div className="min-h-[50vh] flex flex-col items-center justify-center z-10 relative">
                    <h1 className="text-6xl text-center text-slate-100">Welcome to <span className="text-yellow-400">Gaurav Janiyani</span> Blog</h1>
                    <div className="mt-20">
